...
public class GeoPointCell extends AbstractGeoCell implements GeoPointValue {
     ...
     */
	GeoPointCell(final byte[] wkb, final GeoReferenceSystem refCoord) {
		super(wkb, refCoord);
	}

	/**
	 * Factory for {@link GeoPointCell}s.
	 *
	 * @author Tobias Koetter, KNIME GmbH, Konstanz, Germany
	 */
	public static final class CellFactory extends AbstractGeoCellFactory<GeoPointCell> {
	 ...
	 * @author Tobias Koetter, KNIME GmbH, Konstanz, Germany
	 */
	public static class ValueFactory extends GeoValueFactory<GeoPointCell> {
