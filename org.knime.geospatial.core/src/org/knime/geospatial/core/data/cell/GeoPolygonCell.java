...
/**
 * {@link DataCell} implementation that represents a geometric polygon.
 *
 * @author Tobias Koetter, KNIME GmbH, Konstanz, Germany
 */
public class GeoPolygonCell extends AbstractGeoCell implements GeoPolygonValue {
	 ...
	 */
	public static final DataType TYPE = DataType.getType(GeoPolygonCell.class);
     ...
     */
	GeoPolygonCell(final byte[] wkb, final GeoReferenceSystem refCoord) {
		super(wkb, refCoord);
	}
	 ...
	 * @author Tobias Koetter, KNIME GmbH, Konstanz, Germany
	 */
	public static final class CellSerializer extends AbstractGeoCellSerializer<GeoPolygonCell> {
		/**
		 * Constructor for class CellSerializer that is used in the extension point.
		 */
		public CellSerializer() {
			super(GeoPolygonCell::new);
		}
	}
	 ...
	 * @author Tobias Koetter, KNIME GmbH, Konstanz, Germany
	 */
	public static class ValueFactory extends GeoValueFactory<GeoPolygonCell> {
