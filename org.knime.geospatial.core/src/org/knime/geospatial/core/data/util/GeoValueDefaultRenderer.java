...
/**
 * Renderer for {@link GeoValue} which prints the geo type and the CRS.
 *
 * @author Tobias Koetter, KNIME GmbH, Konstanz, Germany
 */
public final class GeoValueDefaultRenderer extends DefaultDataValueRenderer {
	...
	public static final class Factory extends AbstractDataValueRendererFactory {
		...
		public DataValueRenderer createRenderer(final DataColumnSpec colSpec) {
			return new GeoValueDefaultRenderer(colSpec);
		}
	}
}
